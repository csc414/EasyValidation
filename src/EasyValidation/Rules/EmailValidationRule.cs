...
{
    public class EmailValidationRule : RegularExpressionValidationRule
    {
        ...
        public EmailValidationRule() : base(Pattern, RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant | RegexOptions.Singleline)
        {
        }
    }
}